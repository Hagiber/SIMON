...
public final class TextureCatalog {
    ...
    public static final int GREEN_BUTTON_TEXTURE_SLOT = 3;
    ...
    public static List<TextureSpec> defaultScene() {
        return Arrays.asList(
                ...
                new TextureSpec(FIRE_ATLAS_IMAGE_ASSET, 0.0f, 0.0f, 0.5f, 0.0f, 1.00f),
                new TextureSpec(GREEN_BUTTON_PRESS_ATLAS_ASSET, 0.0f, 0.0f, 0.5f, 0.0f, 1.00f)
        );
    }
