...
bool RenderPass::create(VkDevice device, VkFormat colorFormat, std::string *errorMessage) {
    ...
    if (vkCreateRenderPass(device, &renderPassInfo, nullptr, &renderPass_) != VK_SUCCESS) {
        return fail(errorMessage, "Failed to create render pass");
    }
...
void RenderPass::destroy(VkDevice device) {
    if (renderPass_ != VK_NULL_HANDLE && device != VK_NULL_HANDLE) {
